...
textDisplay=Entry(cal,font=('arial',20,'bold'),textvariable=text_Input,bd=30,insertwidth=4,bg="cyan",justify='right').grid(columnspan=4)
#---row=1---

btn7=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),text='7',activebackground='grey',command=lambda:btnClick(7)).grid(row=1,column=0)

btn8=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),text='8',activebackground='blue',command=lambda:btnClick(8)).grid(row=1,column=1)

btn9=Button(cal,padx=16,bd=8,fg='black',font=('arial',20,'bold'),text='9',activebackground='cyan',command=lambda:btnClick(9)).grid(row=1,column=2)
